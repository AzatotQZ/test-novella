...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Старт игры") action Start()
        ...
        if _in_replay:
            ...
            textbutton _("Закончить воспроизведение") action EndReplay(confirm=True)
...
screen main_menu():
    #python:
    #    if stopm == 1:
    #      renpy.music.queue("music/mainmenu_amb.wav",channel = "music",fadein=1)
...
screen about():
    ...
    use game_menu(_("О нас"), scroll="viewport"):
        ...
        vbox:
            ...
            if gui.about:
                text "[gui.about!t]\n"
            text _("Данный проект создан с помощью {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %B %d %Y, %H:%M"), empty=_("Свободный слот")):
            ...
            hbox:
                ...
                if renpy.variant("pc"):
                    ...
                    vbox:
                        style_prefix "radio"
                        label _("Отображение")
                        textbutton _("Оконный режим") action Preference("display", "window")
